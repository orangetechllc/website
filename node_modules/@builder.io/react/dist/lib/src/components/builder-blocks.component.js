...
var BuilderBlocks = /** @class */ (function (_super) {
    ...
    BuilderBlocks.renderInto = function (elementOrSelector, props, builderState) {
        ...
        return react_dom_1.default.render(core_1.jsx(builder_store_1.BuilderStoreContext.Provider, { value: builderState },
            core_1.jsx(BuilderBlocks, __assign({}, props))), element);
    };
