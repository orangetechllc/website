...
var ColumnsComponent = /** @class */ (function (_super) {
    ...
    ColumnsComponent.prototype.render = function () {
        ...
        core_1.jsx(react_1.default.Fragment, null,
            core_1.jsx("div", { className: "builder-columns", css: __assign({ display: 'flex' }, (this.props.stackColumnsAt !== 'never' && (_a = {},
                    _a["@media (max-width: " + (this.props.stackColumnsAt !== 'tablet' ? 639 : 999) + "px)"] = {
                ...
                return (core_1.jsx(react_1.default.Fragment, { key: index },
                    core_1.jsx(TagName, __assign({ className: "builder-column" }, (col.link ? { href: col.link } : null), { 
                        ...
                        css: __assign((_a = { display: 'flex', flexDirection: 'column', alignItems: 'stretch', lineHeight: 'normal' }, _a['& > .builder-blocks'] = {
                            ...
                            _b["@media (max-width: " + (_this.props.stackColumnsAt !== 'tablet' ? 639 : 999) + "px)"] = {
                                width: '100%',
                                marginLeft: 0,
                            },
                            _b))) }),
                        core_1.jsx(builder_blocks_component_1.BuilderBlocks, { key: index, 
...
exports.Columns = with_builder_1.withBuilder(ColumnsComponent, {
    name: 'Columns',
    static: true,
    inputs: [
        {
