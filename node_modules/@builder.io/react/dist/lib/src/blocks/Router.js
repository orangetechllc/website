...
var RouterComponent = /** @class */ (function (_super) {
    ...
    RouterComponent.prototype.render = function () {
        ...
        return (core_1.jsx(builder_store_1.BuilderStoreContext.Consumer, null, function (state) {
            ...
            return (core_1.jsx("div", { className: "builder-router", "data-model": model },
                core_1.jsx("style", null, "\n                @keyframes builderLoadingSpinner {\n                  0% {\n                    transform: rotate(0deg);\n                  }\n                  100% {\n                    transform: rotate(360deg);\n                  }\n                }\n                /* TODO: overridable tag */\n                .builder-page-loading {\n                  -webkit-animation: builderLoadingSpinner 1s infinite linear;\n                  animation: builderLoadingSpinner 1s infinite linear;\n                  -webkit-transform: translateZ(0);\n                  transform: translateZ(0);\n                  border-radius: 50%;\n                  width: 36px;\n                  height: 36px;\n                  margin: 6px auto;\n                  position: relative;\n                  border: 1px solid transparent;\n                  border-left: 1px solid #808284;\n                }\n              "),
                core_1.jsx(builder_component_component_1.BuilderComponent
                ...
                , { 
                    ...
                    key: url, data: _this.props.data, content: _this.routed ? undefined : _this.props.content, modelName: model, options: {
                        key: sdk_1.Builder.isEditing ? undefined : _this.model + ':' + url,
                    } }, _this.props.children || (core_1.jsx("div", { css: { display: 'flex' } },
                    core_1.jsx("div", { css: { margin: '40vh auto' }, className: "builder-page-loading" }))))));
        }));
    };
...
exports.Router = with_builder_1.withBuilder(RouterComponent, {
    name: 'Core:Router',
