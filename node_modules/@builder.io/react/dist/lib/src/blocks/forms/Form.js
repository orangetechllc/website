...
var FormComponent = /** @class */ (function (_super) {
    ...
    FormComponent.prototype.render = function () {
        ...
        core_1.jsx(builder_store_1.BuilderStoreContext.Consumer, null, function (state) { return (core_1.jsx(builder_store_1.BuilderStoreContext.Provider, { value: __assign(__assign({}, state), { state: __assign(__assign({}, state.state), { formErrorMessage: _this.state.formErrorMessage }) }) },
            core_1.jsx("form", __assign({ validate: _this.props.validate, ref: function (ref) { return (_this.ref = ref); }, action: !_this.props.sendWithJs && _this.props.action, method: _this.props.method, name: _this.props.name, onSubmit: function (event) {
                    var _a;
                    ...
                    if (_this.props.sendSubmissionsTo === 'zapier') {
                        ...
                        var formUrl = (sdk_1.builder.env === 'dev' ? 'http://localhost:5000' : 'https://builder.io') + "/api/v1/form-submit?apiKey=" + sdk_1.builder.apiKey + "&to=" + btoa(_this.props.sendSubmissionsToEmail || '') + "&name=" + encodeURIComponent(_this.props.name || '');
                                ...
                                switch (_a.label) {
                                    ...
                                    case 4:
                                        if (!res.ok && this.props.errorMessagePath) {
                                            message = get_1.get(body, this.props.errorMessagePath);
                                            if (message) {
                ...
                _this.props.builderBlock &&
                    ...
                    _this.props.builderBlock.children.map(function (block, index) { return (core_1.jsx(builder_block_component_1.BuilderBlock, { key: block.id, block: block })); }),
                _this.submissionState === 'error' && (core_1.jsx(builder_blocks_component_1.BuilderBlocks, { dataPath: "errorMessage", blocks: _this.props.errorMessage })),
                _this.submissionState === 'sending' && (core_1.jsx(builder_blocks_component_1.BuilderBlocks, { dataPath: "sendingMessage", blocks: _this.props.sendingMessage })),
                _this.submissionState === 'error' && _this.state.responseData && (
                // TODO: tag to edit
                core_1.jsx("pre", { className: "builder-form-error-text", css: { padding: 10, color: 'red', textAlign: 'center' } }, JSON.stringify(_this.state.responseData, null, 2))),
                _this.submissionState === 'success' && (core_1.jsx(builder_blocks_component_1.BuilderBlocks, { dataPath: "successMessage", blocks: _this.props.successMessage }))))); }));
    };
    return FormComponent;
}(react_1.default.Component));
exports.Form = with_builder_1.withBuilder(FormComponent, {
    name: 'Form:Form',
