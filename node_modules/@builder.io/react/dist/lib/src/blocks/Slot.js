...
function Slot(props) {
    var name = props.name;
    var context = react_1.useContext(builder_store_1.BuilderStoreContext);
    var isEditingThisSlot = !context.context.symbolId;
    return (core_1.jsx("div", __assign({ css: {
            pointerEvents: 'auto',
        } }, (isEditingThisSlot && {
        'builder-slot': name,
    })),
        core_1.jsx(builder_blocks_component_1.BuilderBlocks, { child: true, parentElementId: context.context.symbolId, dataPath: "symbol.data." + name, blocks: context.state[name] || [] })));
}
exports.Slot = Slot;
