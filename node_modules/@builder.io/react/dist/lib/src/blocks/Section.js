...
var SectionComponent = /** @class */ (function (_super) {
    ...
    SectionComponent.prototype.render = function () {
        var _this = this;
        return (core_1.jsx("section", { ref: function (ref) { return (_this.ref = ref); }, css: __assign({ width: '100%', 
                ...
                alignSelf: 'stretch', flexGrow: 1, boxSizing: 'border-box', maxWidth: this.props.maxWidth, display: 'flex', flexDirection: 'column', alignItems: 'stretch', marginLeft: 'auto', marginRight: 'auto' }, (this.renderContents ? null : this.props.lazyStyles)) }, this.renderContents ? (core_1.jsx(react_1.default.Fragment, null,
            this.props.children,
            this.props.builderBlock &&
                this.props.builderBlock.children &&
                this.props.builderBlock.children.map(function (block, index) { return (core_1.jsx(builder_block_component_1.BuilderBlock, { key: block.id, block: block })); }))) : null));
    };
